<template>
  <div class="ma-10">
    <h2>Acord Form 27 - Evidence of Property Insurance</h2>
    <a href="/insurance/assets/Acord 27 Template.xlsx"
      >Download the Excel template</a
    ><br />
    <a href="/insurance/assets/Test 27.xlsx">Download a sample file</a><br />
    <br />
    <i>
    ...
    <field-mapping-27
      ...
      @data-mapped="dataMap"
    />
    <v-btn @click="fillOutForm">Fill out Acord 27</v-btn>
    <div v-if="loading">
...
import FieldMapping27 from "../components/FieldMapping27.vue";
...
const fillOutForm = () => {
  ...
  fetch("http://jennifer.obregon.life/cgi-bin/fill-27.pl", {
    method: "POST",
    ...
    .then((blob: any) => {
      ...
      a.download = "merged_acord_27.zip";
      a.click();
    })
    .catch((error: any) => {
